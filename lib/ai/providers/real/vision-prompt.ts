...

{
  ...
  "people": [{ "id": "person-1", "description": "figure, pose, clothing", "visibility": "full | partial", "confidence": 0-1 }],
...
Guidance:
- bbox is normalized to the image, 0..1, origin top-left, tight around the object.
- List 4 to 12 objects, the ones that matter to this memory or to the space. Don't list people as objects.
...
- recommendedRepresentation: "mesh" for the one to three objects most worth holding; "preserve" for things that must not be altered (faces, photographs on the wall, text); "splat" for everything else.
